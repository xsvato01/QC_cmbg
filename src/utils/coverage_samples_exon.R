...
path<-args[1]
path<-"Z:/home/450402/000000-My_Documents/BTK_k8s_testing/launch/220708_TP53_20220708/coverage"
...
write.table(samples_exons, file=paste0(path,"/",args[2], ".perexon_samples.txt"),
